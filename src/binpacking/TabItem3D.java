...
public class TabItem3D {
    
    private int nbItem;
    private ArrayList<Item3D> tabItem;
    
    
    public TabItem3D(){
        
        nbItem = 0;
        tabItem = new ArrayList<Item3D>();
        
    }
    
    public void AjoutItem(Item3D _item){
    ...
    public void initTabItem(){
        ...
        for (int i = 0 ; i < nbItemAAjouter ; i++ ){
            ...
            tabItem.add(new Item3D(tailleXItem, tailleYItem, tailleZItem));
            nbItem++;
        }
    ...
    public void randomize(char langue){
        ...
        int x,y,z;
        Item3D[] item = new Item3D[nbItemAAjouter];
